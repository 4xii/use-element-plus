...
<template>
  ...
  >
    ...
    <el-form-item label="Activity zone" props="region">
    ...
    <el-form-item label="Instant delivery" props="delivery">
      <el-switch v-model="ruleForm.delivery" />
    </el-form-item>
    <el-form-item label="Activity type" props="type">
    ...
    <el-form-item label="Resources" props="resource">
      <el-radio-group v-model="ruleForm.resource">
        <el-radio label="Sponsorship" />
        <el-radio label="Venue" />
      </el-radio-group>
    </el-form-item>
    <el-form-item label="Activity form" props="desc">
